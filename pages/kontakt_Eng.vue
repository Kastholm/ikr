    ...
    <main class="sm:flex sm:flex-row flex flex-col sm:items-start items-center flex-wrap relative sm:mt-28 ">
      ...
      <section class="z-50 sm:w-fit w-[95vw] ">
        ...
        >
          ...
          >
            {{ messageSent ? 'Sent!' : sending ? 'Sending...' : 'Send' }}
          </button>
          <span v-if="messageSent" class="text-white ml-4">Message sent! - we will contact you.</span>
...
async function onSubmit(values) {
  ...
  try {
    ...
    sendError.value = "Failed to send email. Please try again.";
  } finally {
    sending.value = false;
  }
}
